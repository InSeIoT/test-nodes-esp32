...
void SocketIoClient::beginSslWithCA(const char* host, const int port, const char* url, const char* fingerprint) {
	_webSocket.beginSslWithCA(host, port, url, fingerprint);
    initialize();
}
